...
/*
 Complexity:O(1)# it need to for loop it calculate this 
 */
...
/*
 Complexity:O(n) # it have for loob and it is to visit all item in the array &the complex depend of length of array
 */
