...
/*
 Complexity: o(n) / linear time complexity / coz of the for loop 
 */
...
/*
 Complexity: o(n2) / linear time complexity / recursive + slice  
 */
...
/*
 Complexity: o(n2) / linear time complexity / for loop + slice or the second index 
 */
